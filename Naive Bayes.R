...
##............ End of Removing Unnecessary Coulmn.....................# 



newdataset = dataset #A new dataset
result=data.frame(newdataset[,151:168]) #Only contains Severity columns
newdataset[,151:168]=NULL # Removing Severity Columns from the dataset


#....Converting factor values to integer
dd = data.frame(newdataset$Block.ID) 

i=2
while(i<=275){
  c=i-1
  dd=cbind(dd[,1:c],data.frame(as.numeric(newdataset[,i])))
  i=i+1
}

o=1
while(o<=275){
  colnames(dd)[o]=colnames(newdataset)[o]
  o=o+1
}
#......End of Converting factor values to integer
...
classifier = naiveBayes(x = dd[1:1500,2:274],
                        y = result[1:1500,1])

y_predict = predict(classifier, newdata = dd[1501:1718,2:274])

summary(y_predict)
summary(result[1501:1718,1])
#................. End of Naive Bayes....................#
